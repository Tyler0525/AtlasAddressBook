...
namespace AtlasAddressBook.Controllers
{
    public class ContactsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Conatcts.Include(c => c.User);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var contact = await _context.Conatcts
                .Include(c => c.User)
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var contact = await _context.Conatcts.FindAsync(id);
            if (contact == null)
            {
                return NotFound();
            }
        ...
        {
            var contact = await _context.Conatcts.FindAsync(id);
            _context.Conatcts.Remove(contact);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.Conatcts.Any(e => e.Id == id);
        }
    }
}
